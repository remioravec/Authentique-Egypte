 ...
 *
 * Tous deux sont `public => false`. Conséquences voulues :
 * absents des sitemaps (Yoast lit `public`), de la recherche interne,
 * des archives, des flux et du sélecteur de menus. Seul `ae_maquette`
 * est `publicly_queryable` pour disposer d'une URL — l'accès à cette
 * URL est ensuite filtré par capacité (voir AE_Refonte_Rendu).
 */
